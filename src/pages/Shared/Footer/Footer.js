    ...
    <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        <div>
            ...
            <ul className="text-gray-300 dark:text-cyan-800">
                ...
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Careers</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Brand Center</Link>
                </li>
                <li className="mb-4">
                    <Link to='/blogs' className="hover:text-gray-100">Blog</Link>
                </li>
            </ul>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase dark:text-cyan-800">Help center</h2>
            <ul className="text-gray-300 dark:text-cyan-800">
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Discord Server</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Twitter</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Facebook</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Contact Us</Link>
                </li>
            </ul>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase dark:text-cyan-800">Legal</h2>
            <ul className="text-gray-300 dark:text-cyan-800">
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Privacy Policy</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Licensing</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Terms &amp; Conditions</Link>
                </li>
            </ul>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase dark:text-cyan-800">Download</h2>
            <ul className="text-gray-300 dark:text-cyan-800">
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">iOS</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Android</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">Windows</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' className="hover:text-gray-100">MacOS</Link>
                </li>
            </ul>
        </div>
    </div>
    <div className="py-6 px-4 bg-dark dark:bg-cyan-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-cyan-700 dark:text-gray-300 sm:text-center">© 2022 All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <Link to='/' className="text-cyan-800 hover:text-cyan-700 dark:hover:text-white">
