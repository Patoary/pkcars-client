...
const TableDetail = ({ product, handleDelete }) => {
    ...
    return (
        <>
            ...
            >
                <td className="w-1/5 py-3 px-6 border-x dark:text-white whitespace-nowrap text-center">
               ...
               onClick={()=> handleDelete(_id)}
                className="bg-red-300 py-2 px-3 text-base rounded-full cursor-pointer">
